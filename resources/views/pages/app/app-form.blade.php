        ...
        <div class="col-md-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group mt-4"><label for="order">Order</label> <input type="text" id="form-order" name="order" class="form-control"> <div class="invalid-feedback feedback-urut"></div></div>
            </div>
          </div>
        </div>
        <div class="col-md-6">
